# Divis-Drag-Race - Interactive Game
...
- **Game Start Screen:**
  ...
  - *Markdown:* `![Game Start Screen]([/assets/images/readme/start%20screen.png](https://github.com/Da-vinia/Divis-Drag-Race/blob/main/assets/images/readme/start%20screen.png))`
